      ...
      <div className='px-10'>
             ...
             id="campaignName"
              name="campaignName"
               placeholder='e.g The future is now'
                className='outline-none border border-gray-500 w-[60%] px-5 py-2 mt-2 rounded-md'
       ...
       value={formData.endDate} className='outline-none border-2-black border p-2' onChange={handleChanges} />
          ...
          <div className=' w-full '>
            ...
            <div>
              <select id='digestCampaign'
               name='digestCampaign'
                onChange={handleChanges}
                 className='w-[60%] p-2 bg-gray-200 outline-none' 
          ...
          <div>
            ...
            <select id="dailyDigest" className='w-[60%] mt-2 p-1 outline-none border-2 px-2' value={formData.dailyDigest} onChange={handleChanges}>
          ...
          <div className='flex flex-col md:flex-row gap-6'>
            ...
            <button type='submit' className='w-[300px] text-[#247B7B] font-bold border-2 border-[#247B7B] py-2 rounded-md'>Edit Campaign</button>
          </div>
        </form>
      </div>
    </div>
